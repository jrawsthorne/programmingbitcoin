...
test("parse", () => {
  ...
  expect((script.cmds[0] as PushDataOpcode).data.equals(want)).toBe(true);
  want = Buffer.from(
    "035d5c93d9ac96881f19ba1f686f15f009ded7c62efe85a872e6a19b43c15a2937",
    "hex"
  );
  expect((script.cmds[1] as PushDataOpcode).data.equals(want)).toBe(true);
});
